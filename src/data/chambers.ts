...
export const UK_CHAMBERS: ChamberRecord[] = [
  ...
  {
    name: 'London Hyperbaric Medicine',
  ...
  },
  {
    ...
    location: 'Spire Hull & East Riding Hospital, Hull',
    phone: '+441482659471',
  ...
  {
    name: 'East of England Hyperbaric Unit',
    location: 'James Paget Hospital, Great Yarmouth',
    phone: '+441493603151',
    status: 'Fully operational',
    latitude: 52.5741,
    longitude: 1.7218,
